    ...
    return (
        <>
            <div className="content">
                <Row className={"rounted-card-container"}>
                    {[1, 2, 3, 4, 5].map((reading, index) => {
                        return (
                            <div className={"rounded-box"}>
                                <div className={"inner-round-1"}>
                                    <div className={"inner-round-2"}>
                                        sdaf
                                    </div>
                                </div>
                            </div>
                ...
                <Row>
                    <Col xs={4}>
                        <Card className="card-chart card-chart-condition">
                            <CardHeader>
                                <CardTitle tag="h1" style={{display: "flex",justifyContent: "center", fontSize: "5rem", fontWeight: "1000"}}>
                                    25
                                </CardTitle>
                            </CardHeader>
                            <CardBody>
                                <div className="chart-area condition" style={{height: "190px"}}>
                                ...
                                <Row>
                                    ...
                                    <Col sm="6">
                                        ...
                                        >
                                            ...
                                            >
                        <span className=" d-none d-sm-block d-md-block d-lg-block d-xl-block" style={{width: "50px"}}>
                          PM 2.5
                        </span>
